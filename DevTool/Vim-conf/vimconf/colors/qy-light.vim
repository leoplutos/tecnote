...
hi CursorLine   term=reverse cterm=none ctermbg=254 gui=none guibg=#e4e6f0
...
hi PmenuFg      ctermfg=233 guifg=#121212
...
hi ColorColumn  term=reverse ctermbg=255 guibg=#efebe0
"QuickFixLine选中行
...
if has('nvim')
  ...
  hi FloatBorder term=none cterm=none ctermfg=236 ctermbg=254 gui=none guifg=#2c2c2c guibg=#ede7d5
