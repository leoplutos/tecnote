...
if (vim.g.g_i_osflg == 1 or vim.g.g_i_osflg == 2 or vim.g.g_i_osflg == 3) then
  ...
  dashboard_bookmarks[#dashboard_bookmarks + 1] = 'D:/WorkSpace/Java/JavaBatchProject'
  ...
  dashboard_bookmarks[#dashboard_bookmarks + 1] = 'D:/WorkSpace/Vue/VueTestProject'
  ...
  dashboard_bookmarks[#dashboard_bookmarks + 1] = '~/work/lch/workspace/java/JavaBatchProject'
  ...
  dashboard_bookmarks[#dashboard_bookmarks + 1] = '~/work/lch/workspace/vue/VueTestProject'
