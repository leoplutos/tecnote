...
public class EtcdBenchmark {
	...
	public void tearDown() {
		System.out.println("Etcd 测试结束");
	}

	// testMethod 是一个 Benchmark 方法。我们可以直接在 testMethod 方法中编写测试代码，也可以调用父项目的方法
	@Benchmark
	public void etcdTest(Blackhole blackhole) throws InterruptedException {
		Etcd etcd = new Etcd();
		etcd.runEtcd();
	}
	...
	public static void main(String[] args) throws RunnerException {
		Options opt = new OptionsBuilder()
				.include(EtcdBenchmark.class.getSimpleName())
				.forks(1)
				.build();
